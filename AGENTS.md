...
- For prompt-cache work, prioritize core prefix construction first, session compaction second, fresh-context subagents third, and tool stability fourth. Prioritize cache reuse for fresh-context subagents over forked-history subagents; forked-history behavior belongs later because it is less common and avoidable.
